            ...
            return(
              <Row>
                <Col className="lesson-header" md={9} onClick={(e) => getCourseUnitPagesContent(e, moduleid, item.id)}>
                  {item?.pageName}
                  {modulePagesContent?.pageName}
                </Col>
                <Col className="align-right-content" md={3}>
                  <Button className="m-r-5 color-white tficolorbg-button" size="sm" onClick={(e) => handleOpenEditLessonModal(e, selectedPage)}><i className="fa fa-edit"></i></Button>
